    ...
    return (
        <section className="max-lg:my-10 my-20">
            <div className="container mx-auto px-4">
                <div className="flex gap-10 mt-10 max-lg:flex-col max-lg:gap-10">
                    {/* Author Portrait Container */}
                    <div className="overflow-hidden rounded-4xl max-lg:rounded-xl shadow-xl shrink-0">
                        <Image
                            loading="eager"
                            className="aspect-square w-full lg:w-lg max-h-128 object-cover hover:scale-105 transition-transform duration-500"
                    ...
                    <div className="flex-1 justify-center flex flex-col gap-4">
                        ...
                        <hr className="border-none h-px w-full bg-linear-to-r from-gray-400 to-transparent my-2" />
